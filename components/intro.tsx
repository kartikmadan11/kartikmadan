...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <motion.h1
        className="mb-8 mt-4 px-4 text-xl font-normal !leading-[1.6] sm:text-2xl text-gray-700 dark:text-gray-100"
      ...
      >
        ...
        <span className="font-medium text-purple-600 dark:text-white">
          cloud technologies
        </span>
        ...
        <span className="font-medium text-rose-600 dark:text-white">
          machine learning
        </span>
        .
      </motion.h1>
